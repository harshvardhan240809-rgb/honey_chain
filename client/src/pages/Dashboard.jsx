  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="panel p-4 rounded shadow">Total Hives<div className="text-2xl font-bold">{total}</div></div>
        <div className="panel p-4 rounded shadow">Healthy Hives<div className="text-2xl font-bold">{healthy}</div></div>
        <div className="panel p-4 rounded shadow">Honey Produced<div className="text-2xl font-bold">35 Kg</div></div>
        <div className="panel p-4 rounded shadow">Active Batches<div className="text-2xl font-bold">3</div></div>
      </div>
